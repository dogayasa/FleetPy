...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        scs_path = os.path.join(os.path.dirname(__file__), "studies", "DriversOnly", "scenarios")
   
        """
        EXPERIMENTS FOR DRIVER FLEET 
        ...
        5 - Scenario with different shift start hour gap and larger fleet size for 5 days.
        """
